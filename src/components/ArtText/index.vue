<template>
    <div class="arttext">
        ...
        <input type="text" class="input" id="artinput" />

    </div>
</template>
<script setup lang="ts">
import { ref, reactive, onMounted, watch } from 'vue'
import {TweenLite,Power3,Back,Power1} from 'gsap'
onMounted(() => {
    const selectSVG = id => {
    ...
    let textCenter = 0;
    const letters = [];
    const prompt = ['f', 'i','f', 'i','f', 'i','f', 'i','f', 'i','f', 'i','f', 'i','f', 'i','f', 'i',];
    let runPrompt = true;
